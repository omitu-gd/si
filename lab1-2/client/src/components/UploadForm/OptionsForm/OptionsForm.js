    ...
    render() {
        return (
            <div className="OptionsForm">
                <form>
                    <div className="OptionsForm__RefreshButton" style={{display:'none'}} onClick={this.onRefreshClick}><img src="https://img.icons8.com/ios-glyphs/18/000000/synchronize.png" alt="Refresh icon"/>Refresh</div>

                    <div className="OptionsForm__Title" style={{display:'none'}}>Method</div>
                    <div className="OptionsForm__Type">
                        ...
                        <div className="OptionsForm__Type--Right">
                            <Radio
                                ...
                                aria-label="B"
                                color="primary"
                            /> <span >Decripteaza</span >
                        </div>
                    </div>

                    <div className="OptionsForm__Title" style={{display:'none'}}>Type</div>

                    <div className="OptionsForm__Type" style={{display:'none'}}>
                        <div className="OptionsForm__Type--Left" >
                            <Radio
                ...
                <div className="OptionsForm__SubmitButton">
                    {
                        this.props.doneProcessing ?
                            ...
                            (<button onClick={this.props.onUploadFormSubmit}>{this.props.method === 0 ? "Cripteaza" : "Decripteaza"}</button>)
                    }
                </div>
            </div>
        );
