            ...
            <form className="UploadForm__Plaintext">
                <label htmlFor="plaintext">
                    <div>
                        ...
                        <div className="UploadForm__FileName">{this.props.plaintextFileName || this.props.plaintextFolderName || (this.props.type !== 0 ? `${this.props.method === 0 ? "Cripteaza" : "Decripteaza"}`: `${this.props.method === 0 ? "Cripteaza" : "Decripteaza"}`)}</div>
                    </div>
